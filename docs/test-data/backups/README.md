...
- anschließend die Schritte aus [release-smoke-test-beta-to-main.md](/Users/carlosanderssohn/Claude/Arbeit/ToDo-Manager/docs/testing/release-smoke-test-beta-to-main.md) durchgehen
