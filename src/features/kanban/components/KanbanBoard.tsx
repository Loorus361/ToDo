...
import { getDeadlineStatus, deadlineTextClass } from '../../../shared/lib/deadlineColors';
import { createTodo, deleteTodo, updateTodo } from '../../todos/data/todos';
