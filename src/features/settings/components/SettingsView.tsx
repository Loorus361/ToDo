...
const TABS = [
  { id: 'general' as const, label: 'Allgemein', icon: <Settings size={14} /> },
  { id: 'honorar' as const, label: 'Honorar', icon: <Calculator size={14} /> },
];
...
export default function SettingsView() {
  ...
  return (
    <div className="max-w-lg">
      ...
      {/* ── Tab: Honorar ── */}
      {activeTab === 'honorar' && <HonorarSettingsSection />}
    </div>
  );
}
